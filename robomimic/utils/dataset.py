...
class SequenceDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        self.use_ours_ratio = use_ours_ratio
    ...
    def get_item(self, index):
        ...
        if self.use_weighted_bc:
            ...
            meta["hc_weights"] = torch.Tensor([weight_dict[label] for label in intv_labels]).to(torch.float32)
    ...
    def _get_iwr_ratio(self):
        ...
        # a variant: just decrease preintv weight
        self.w_demos = 1
        self.w_intvs = 1
        self.w_rollouts = 1
        self.w_pre_intvs = 0.0001

    def _get_ours_ratio(self):
    ...
    def _update_weights(self):
        ...
        if self.use_ours_ratio:
            self._get_ours_ratio()
...
class MetaDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        print("remove_preintv_only_sampling", self.remove_preintv_only_sampling)
        ...
        if remove_preintv_only_sampling:
            ...
            print("total_weights", len(self.total_weights))
