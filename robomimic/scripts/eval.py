...
def main_eval(args):
    ...
    def env_iterator():
        for (env_meta, shape_meta, env_name) in zip(eval_env_meta_list, eval_shape_meta_list, eval_env_name_list):
            ...
            if args.use_training_objects:
                env_meta = env_meta_hardcode
            ...
            def create_env_helper(env_i=0):
                ...
                if config.train.frame_stack == 20: # hack for dyn training
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use-training-objects', action="store_true")
